...
KComponentData::KComponentData(const QByteArray &name, const QByteArray &catalog, MainComponentRegistration registerAsMain)
    : d(new KComponentDataPrivate(/*KAboutData(name, catalog, "", "", "")*/))
{
...
{
    qCritical()<<"====== void KComponentDataPrivate::lazyInit(const KComponentData &component) ====";
//    if (dirs == 0) {
...
{
    qCritical()<<"============KComponentDataPrivate::configInit(const KComponentData &component)===============";
